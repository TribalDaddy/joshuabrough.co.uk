...
p('Aspiring finance professional with a strong analytical foundation and hands-on industry experience. PPE graduate from Lancaster University and current MSc Accounting and Finance student at LSE. Interested in how people, markets and organisations make decisions.','SubtitleJB')
section('Education')
entry('<b>London School of Economics</b> | MSc Accounting and Finance','London, UK | September 2026 - June 2027 | Current student','Currently developing a deeper understanding of financial information and business decision-making.')
